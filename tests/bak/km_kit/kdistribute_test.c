...
int main()
{
    ...
    if (ret != LD_KM_OK)
    {
        log_warn("[**AS derive_key KAS-GS error**]\n");
        return 0;
    }
    else
    {
        log_warn("[**AS derive_key KAS-GS OK  **]\n");
    }
    ...
    if (ret != LD_KM_OK)
    {
        log_warn("[**AS derive_key KU-ENC error**]\n");
        return 0;
    }
    else
    {
        log_warn("[**AS derive_key KU-ENC OK  **]\n");
    }
    /**************************************************
     *                    SGW端                        *
     **************************************************/
    ...
    log_warn("[**GS derive_key KU-ENC OK  **]\n");
    return 0;
}